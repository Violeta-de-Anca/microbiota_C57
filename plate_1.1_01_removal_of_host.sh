...
#SBATCH -J 01plate1.1
#SBATCH --error /proj/naiss2024-23-57/C57_female_lineage_microbiota/log_files/01_plate1.1_host_removal_%j.err
#SBATCH --output /proj/naiss2024-23-57/C57_female_lineage_microbiota/log_files/01_plate1.1_host_removal_%j.out
