...
#SBATCH -J 01plate7
#SBATCH --error /proj/naiss2024-23-57/C57_female_lineage_microbiota/log_files/01_plate7_host_removal_%j.err
#SBATCH --output /proj/naiss2024-23-57/C57_female_lineage_microbiota/log_files/01_plate7_host_removal_%j.out
...
input_1=$1/${a}_1.merged.fastq.gz
input_2=$1/${a}_2.merged.fastq.gz
