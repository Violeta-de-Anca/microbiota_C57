...
#SBATCH -J b_BAT_%j
#SBATCH --error=/proj/naiss2024-23-57/C57_female_lineage_microbiota/log_files/metaBAT2/bins_metaBAT2_%j.err
#SBATCH --output=/proj/naiss2024-23-57/C57_female_lineage_microbiota/log_files/metaBAT2/bins_metaBAT2_%j.out
...
mkdir -p $output_folder/$a/metaBAT2

metawrap binning -o $output_folder/$a/metaBAT2 -a $temp_assembly --metabat2 -m 64 -t 8 $1/final_pure_reads_*
