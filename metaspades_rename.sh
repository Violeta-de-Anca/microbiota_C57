...
#SBATCH --error /proj/naiss2024-23-57/C57_female_lineage_microbiota/log_files/metaspades_rename_and_gzip.err
#SBATCH --output /proj/naiss2024-23-57/C57_female_lineage_microbiota/log_files/metaspades_rename_and_gzip.out
...
gzip /proj/naiss2024-23-57/C57_female_lineage_microbiota/assembled_metagenomes/*metaspades*fasta
