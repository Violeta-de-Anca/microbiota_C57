...
folder_fastq=/proj/naiss2024-23-57/C57_female_lineage_microbiota/samples/last_feces
...
metawrap quant_bins -b $bins_folder -o $output_folder -t 8 -a $temp_assembly $temp_dir/LF_${c}*fastq*
