...
#SBATCH -J reassem
#SBATCH --cpus-per-task=10 --ntasks=2
...
#check path is short
python - <<'PY'
import tempfile; print("TMP dir:", tempfile.gettempdir())
PY
...
metawrap reassemble_bins -o $output_folder -b $bins_folder -1 $temp_fastq1 -2 $temp_fastq2 -t 20
